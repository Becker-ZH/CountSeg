...
With a correct setup of environment requirements, please run 1.ipynb in a Google Colab or Jupyter Notebook. If run 1.ipynb in a separate file in the Google Colab, you need to first run environment setup code given in our main code by Google Colab and could also be found in the Github link above. 
